...
namespace CrmBox.Persistance.Migrations.CrmBoxIdentity
{
    ...
    [Migration("20220906103018_chatAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrmBox.Core.Domain.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CrmBox.Core.Domain.Message", b =>
                {
                    ...
                    b.HasOne("CrmBox.Core.Domain.Room", "ToRoom")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("CrmBox.Core.Domain.Room", b =>
                {
                    b.HasOne("CrmBox.Core.Domain.Identity.AppUser", "Admin")
                        .WithMany("Rooms")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("CrmBox.Core.Domain.Identity.AppUser", null)
                        .WithMany()
